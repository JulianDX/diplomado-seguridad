...
public class EchoClient {
	...
	public void protocol(Socket socket) throws Exception {
		...
		toNetwork.println(nombre);
		
		System.out.print("Escriba el saldo: ");
		String saldo = SCANNER.nextLine();

		toNetwork.println(saldo);
		
		Usuario user = new Usuario(nombre, 150.0);
		byte[] userBA = Util.objectToByteArray(user);
